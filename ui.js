  ...
  `;
	...
	return html`
      <dialog class="cfg" style="background-color: #121212; color: white; border-radius: 8px;">
        <div style="align-self: end">
          <div class=${[flex, "buttons"]}>
            <button on:click=${() => {
						...
						}}>use bare server 3 (never works)</button>
            <button on:click=${() => {
        ...
        <div>You are using ${use(store.transport)}</div>
...
function BrowserApp() {
  ...
  `;
    ...
    <body style="background:#000;color:#fff">
      Welcome to <i>Scramjet</i>!
      Type in a URL in the omnibox above and press enter.
    </body>
    `;
